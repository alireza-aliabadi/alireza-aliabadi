...
### Techs & Skills:
[![Skills](https://skillicons.dev/icons?i=python,go,typescript,rust,bash,git,gitlab,redis,postgres,mysql,mongo,docker,kubernetes,linux,ansible,grafana,prometheus,nginx,postman,fastapi,aws,azure,elasticsearch,regex&perline=7)]()
